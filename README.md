...
Our task during the exercise was:

* Edit this document
* Defining and implementing a new feature
* Resolving a merge conflict
* Integrating [*Travis*](https://travis-ci.org/) with this repository
* Adding external dependencies like the *tachograph* module using [*Google's Guava library*](https://github.com/google/guava)